<x-layout bodyClass="bg-gray-200">
        ...
        <main class="main-content  mt-0">
            ...
            style="background-image: url('https://theme7x.com/fastway/images/main-slider/slider1/slide2.jpg');">
                            ...
                            <div class="card z-index-0 fadeIn3 fadeInBottom">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                        <!--<img src="{{ asset('public/assets/img/carga.png') }}" alt="Descripción de la imagen" class="img-fluid">-->
                                        <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Bienvenido</h4>
                                        <div class="row mt-3">
                                            <h6 class='text-white text-center'>
                                                <span class="font-weight-normal"></span> Transporte de 
                                                Carga
                                                <br>
                                                <span class="font-weight-normal"></span> Sistema de Transporte</h6>
                                            <div class="col-2 text-center ms-auto">
                                                <a class="btn btn-link px-3" href="javascript:;">
                                                    <i class="fa fa-box text-white text-lg"></i>
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-2 text-center me-auto">
                                                <a class="btn btn-link px-3" href="javascript:;">
                                                    <i class="fa fa-user-tie text-white text-lg"></i>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login') }}" class="text-start">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            ...
                                            <input type="email" class="form-control" name="email" value="{{ 'linner@gmail.com' }}">
                                        </div>
                                        @error('email')
